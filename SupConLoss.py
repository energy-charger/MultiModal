...
x = representations.unsqueeze(1)
y = representations.unsqueeze(0)
# 这步得到它的相似度矩阵
...
# print(torch.nonzero(loss))
print(torch.sum(loss, dim=1))
print(mask_loss)
loss = torch.sum(torch.sum(loss, dim=1)/mask_loss)
